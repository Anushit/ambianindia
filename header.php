...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
      a.page-link.active {
        background: #290f02 !important;
        color: #fff;
      }
    </style>
  </head>
  <body class="">
    <div class="ie-panel"><a href="https://windows.microsoft.com/en-US/internet-explorer/"><img src="<?=BASE_PATH?>images/warning_bar_0000_us.jpg" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today." width="820" height="42"></a></div>
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="block-right" style="font-size: 9px;">
                    <ul class="list-inline nav-list">
                       <li class="list-inline-item"><a href="<?=BASE_PATH?>index">Home</a></li>
                      <li class="list-inline-item"><a href="<?=BASE_PATH?>about">About Us</a></li>
                      ...
                      <li class="list-inline-item"><a href="<?=BASE_PATH?>giftcard">Gift Card</a></li>
                      <li class="list-inline-item"><a href="<?=BASE_PATH?>contact_us">Contact</a></li>
                    </ul>
                      ...
                      <div class="rd-navbar-aside">
                        <ul class="list-inline header-soc-list">
                         ...
                         <!--  <li <?php if (empty($twitter_link)){?>style="display:none"<?php }?>><a class="icon fa-twitter" href="<?=$twitter_link?>" target="_blank"></a></li> -->
                          ...
                          <li style="vertical-align: bottom;"><a href="https://app.ambianceofindia.ca/order/" target="_blank"><img src="<?=BASE_PATH?>images/header3.png"></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div class="rd-navbar-main-element"> 
                  <div class="rd-navbar-nav-wrap toggle-original-elements">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="<?=BASE_PATH?>about">About Us</a>
                      </li>
                      ...
                      <li class="rd-nav-item"><a class="rd-nav-link" href="<?=BASE_PATH?>giftcard">Gift Card</a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="<?=BASE_PATH?>contact_us">Contact</a>
                      </li>
                    </ul>
                  </div>
                </div>
