        ...
        <div class="container wow-outer">
          <div class="wow fadeIn" style="visibility: hidden; animation-name: none;">
            <div class="row row-60">
              <div class="col-12"><a href="<?=BASE_PATH?>index"><img src="<?=ADMIN_PATH.$logo?>" alt="" width="300"></a></div>
              <div class="col-12" style="font-size: 12px;">
                <ul class="footer-minimal-nav">
                  ...
                  <li><a href="<?=BASE_PATH?>giftcard">Gift Card</a></li>
                  <li><a href="<?=BASE_PATH?>contact_us">Contact</a></li>
            ...
            <div class="rights"><?=$footer_setting['data']['copyright']?> | Developed By : <a href="https://adiyogitechnosoft.com" target="_blank">Adiyogi Technosoft pvt. ltd.</a></div>
          </div>
        </div>
      </footer>
